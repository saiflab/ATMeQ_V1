...
# ==========================================================
# Navigation (Desktop buttons + Mobile ☰ popover)
# ==========================================================

# ----- Desktop nav (unchanged buttons) -----
...
# ----- Mobile nav (☰ icon in top area) -----
st.markdown('<div class="mobile-nav">', unsafe_allow_html=True)
with st.popover("☰", use_container_width=False):
    st.markdown("### Navigation")
    if st.button("🏠 Home", use_container_width=True, key="m_home"):
        st.session_state.page = "Home"
    if st.button("📊 Prediction", use_container_width=True, key="m_pred"):
        st.session_state.page = "Prediction"
    if st.button("👥 Team", use_container_width=True, key="m_team"):
        st.session_state.page = "Team"
st.markdown("</div>", unsafe_allow_html=True)
